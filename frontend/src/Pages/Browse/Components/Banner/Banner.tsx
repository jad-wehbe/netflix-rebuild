    ...
    return (
        <Styles.Container>
            <Styles.Banner>
                ...
                <Styles.List>
                    <Styles.ListItem>{show?.release_date?.split('-')[0]}</Styles.ListItem>
                    <Styles.ListItem>{show?.adult ? "+18" : "PG-G"}</Styles.ListItem>
                    <Styles.ListItem>Rate: {show?.vote_average}</Styles.ListItem>
